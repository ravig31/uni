...
describe("Exercise 2: len", () => {
    it("Generated code exists", () => {
        try {
...
describe("Exercise 3: deepEqual", () => {
    ...
    it("first list empty", () =>
        expect(deepEqual(<ConsList<number>>null)(l)).to.be.false);
...
describe("Exercise 7: what are the indices of a 5x4 spreadsheet?", () => {
    ...
    it("There should be 20 indices", () => {
        expect(len(concatMap(indices)(rows))).to.equal(20);
    });

    it("The indices are A1,B1,C1,D1,E1,A2,B2,C2,D2,E2,A3,B3,C3,D3,E3,A4,B4,C4,D4,E4", () => {
        // generate all cell indices in the table
        const concatMapSolution = concatMap(indices)(rows);
        expect(String(toArray(concatMapSolution))).to.equal(
